...
prediction: boolean, inLiquidRadiusMultiplier?: number): {
    chainSource: HasSpace;
    entity: HasSpace;
}[];
export declare function getNextConnectingEntities(source: HasSpace, baseRadius: number, chainsLeft: number, potentialTargets: HasSpace[], prediction: boolean, inLiquidRadiusMultiplier?: number): {
    chainSource: HasSpace;
    entity: HasSpace;
}[];
